  ...
  return [
...

    {
      ...
      items: [
        {
          text: 'Nuxt3.x (计划)',
          link: `/redirect?antdvr.\${domain}.io/docs/nuxt3.x`,
          target: '_blank',
        },
      ],
    },
...
function createGuide() {
  return [
    ...
    {
      text: 'Bug 问题反馈',
      link: 'https://github.com/antdvr/vue-template-3.x/issues',
      collapsed: true,
      items: [],
    },
  ]
  ...
  return [
...

    {
      ...
      items: [
        {
          text: 'Bug 反馈',
          link: 'https://github.com/antdvr/library-3.x/issues',
        },
      ],
    },
  ]
...
export const zh = defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      message: '基于 MIT 许可发布',
      copyright: `版权所有 © 2025-${new Date().getFullYear()} Antdvr`,
    },
